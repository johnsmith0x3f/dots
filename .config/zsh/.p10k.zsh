# Generated by Powerlevel10k configuration wizard on 2024-12-28 at 02:03 UTC.
...
# angled separators, sharp heads, round tails, 2 lines, dotted, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=4
	# Default current directory foreground color (254).
  ...
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=
	# Color of the shortened directory segments (250).
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=0
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
	# segment is always an anchor (255).
